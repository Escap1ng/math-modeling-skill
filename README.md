...
<p align="center">
  <img src="https://img.shields.io/github/v/release/Escap1ng/math-modeling-skill?color=2196F3&label=%E7%89%88%E6%9C%AC" alt="版本">
...
>
> 覆盖<strong>赛题理解 → 模型构建 → 算法实现 → 论文输出 → 质量自评</strong>完整链路，专为<strong>高教社杯全国大学生数学建模竞赛（CUMCM）</strong>设计，同时适用于其他数学建模赛事。推荐使用多模态AI模型。
