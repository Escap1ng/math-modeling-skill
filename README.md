...
> <sub>**免责声明：** 本工具由 AI 驱动，生成的所有内容（包括但不限于论文文本、代码、图表、数据结果）仅供学习和参考，不构成最终提交成果。使用者须自行核实所有公式推导、数值结果及参考文献的准确性。论文排版格式请以赛事官方最新通知为准。使用者应确保其提交内容符合所在赛事的学术诚信要求，因使用本工具产生的任何后果由使用者自行承担。</sub>
